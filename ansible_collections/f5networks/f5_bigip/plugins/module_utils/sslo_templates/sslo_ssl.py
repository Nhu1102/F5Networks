       ...
       },
       {
          ...
          "value":{
             ...
             "clientSettings":{
                ...
                "certKeyChain":[
                   {
                      ...
                      "chain": {% if params.client_chain is defined %}"{{ params.client_chain }}"{% else %}""{% endif %},
                      "passphrase":"",
                ...
                "caCertKeyChain": {% if params.proxy_type == "forward" %}[
                    {
                        ...
                        "chain": {% if params.client_ca_chain is defined %}"{{ params.client_ca_chain }}"{% else %}""{% endif %},
                        "isCa": true,
                        "usage": "CA",
                        "port": "0",
                        "passphrase": "",
                ...
                "enabledSSLProcessingOptions": {% if params.client_enable_tls13 is defined %}{{ params.client_enable_tls13 | tojson }}{% else %}[]{% endif %}{% if params.client_log_publisher is defined %},
             ...
             "serverSettings":{
                ...
                "ocsp": "{{ params.ocsp }}",
                "crl": "{{ params.crl }}",
                "enabledSSLProcessingOptions": {% if params.server_enable_tls13 is defined %}{{ params.server_enable_tls13 | tojson }}{% else %}[]{% endif %}{% if params.server_log_publisher is defined %},
